...
- **[Daily Standup Format](scribe/docs/STANDUP-FORMAT.md)** — Async standup format for AI teammates: Done/Next/Blockers/Handoffs, posted daily to `.teammates/standups/YYYY-MM-DD.md`. _(added 2026-03-14)_
